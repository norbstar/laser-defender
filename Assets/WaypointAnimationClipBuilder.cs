...
//            AnimationCurve xAnimationCurve = CreateXCurve(path.transform, /*duration*/ClipDuration, keyframeCount, !smoothing.smoothXTangents);
//            AnimationCurve yAnimationCurve = CreateYCurve(path.transform, /*duration*/ClipDuration, keyframeCount, !smoothing.smoothYTangents);
...
//            AnimationFunctionsOriginal.SaveClip(animationClip, assetPath, assetName);
//        }
